...
import { TrainModelInput } from "@repo/common/inferred"
...
export function Train() {
    ...
    return (
        ...
        <Card className="w-[600px] px-4">
            <CardHeader>
                <CardTitle>Train New Modal</CardTitle>
                <CardDescription>Create a custom AI model with your photos</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="grid w-full items-center gap-4">
                    ...
                    <div className="flex flex-row gap-8">
                        ...
                        <div className="flex flex-col space-y-1.5">
                            <Label htmlFor="name" className="pb-2">Bald</Label>
                            <Switch onClick={(e) => {
                                setBald(!bald)
                            }} />
                        </div>
